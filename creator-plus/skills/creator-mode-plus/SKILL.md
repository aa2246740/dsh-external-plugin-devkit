...
4. Add focused unit tests, build the package, then call `dshx_check`. Completion: tests and build pass, and a client package has a built lazy-CJS `lib/client.js` handoff.
